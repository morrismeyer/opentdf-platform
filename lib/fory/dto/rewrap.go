...
type RewrapRequest struct {
	...
	SignedRequestToken string `fory:"signedRequestToken"`
}
...
type UnsignedRewrapRequest struct {
	...
	ClientPublicKey string `fory:"clientPublicKey"`

	// Requests is the list of policy requests to be processed.
	Requests []*WithPolicyRequest `fory:"requests"`
}
...
type WithKeyAccessObject struct {
	...
	KeyAccessObjectID string `fory:"keyAccessObjectId"`

	// KeyAccessObject is the actual Key Access Object containing cryptographic material.
	KeyAccessObject *KeyAccess `fory:"keyAccessObject"`
}
...
type WithPolicyRequest struct {
	...
	KeyAccessObjects []*WithKeyAccessObject `fory:"keyAccessObjects"`

	// Policy is the policy information for this group of KAOs.
	Policy *WithPolicy `fory:"policy"`
...
type RewrapResponse struct {
	...
	SessionPublicKey string `fory:"sessionPublicKey"`

	// Responses is the policy-grouped rewrap results for the bulk API.
	Responses []*PolicyRewrapResult `fory:"responses"`
}
...
type PolicyRewrapResult struct {
	...
	PolicyID string `fory:"policyId"`

	// Results contains results for each KAO under this policy.
	Results []*KeyAccessRewrapResult `fory:"results"`
}
...
type KeyAccessRewrapResult struct {
	...
	Metadata map[string]interface{} `fory:"metadata"`
...
type PublicKeyResponse struct {
	...
	PublicKey string `fory:"publicKey"`
