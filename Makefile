...
MODS=protocol/go lib/ocrypto lib/fixtures lib/flattening lib/fory lib/identifier sdk service examples
HAND_MODS=lib/ocrypto lib/fixtures lib/flattening lib/fory lib/identifier sdk service examples
